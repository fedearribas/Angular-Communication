...
export class ProductService {
  ...
  getProduct(id: number): Observable<IProduct> {
    ...
    if (this.products) {
      this.foundItem = this.products.find(x => x.id == id);
      if (this.foundItem)
        return of(this.foundItem);
    }
  ...
  deleteProduct(id: number): Observable<IProduct> {
    ...
    return this.http.delete<IProduct>(url, { headers: headers })
      .pipe(
        ...
        tap(data => {
          const foundElement = this.products.find(x => x.id == id);
          if (foundElement) {
            const elementIndex = this.products.indexOf(foundElement);
            this.products.splice(elementIndex);
